                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control ih-medium ip-gray radius-xs b-light px-15 form-select" id="status_filter">
                                                ...
                                                <option value="not_created"><?php echo e(__('order::request-quotation.status_not_created')); ?></option>
                                                <option value="created"><?php echo e(__('order::request-quotation.status_created')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <table id="quotationsDataTable" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th><span class="userDatatable-title"><?php echo e(__('order::request-quotation.contact_info')); ?></span></th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-view', function() {
                ...
                const statusLabels = {
                    'not_created': '<?php echo e(__('order::request-quotation.status_not_created')); ?>',
                    'created': '<?php echo e(__('order::request-quotation.status_created')); ?>',
