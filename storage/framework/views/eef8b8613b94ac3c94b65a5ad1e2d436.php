...
<?php endif; ?>
                ...
                <div class="ap-po-details ap-po-details--2 p-25 radius-xl" style="border-left: 4px solid <?php echo e(config('branding.colors.primary')); ?>;">
                    <div class="overview-content">
                        <div class="ap-po-details__titlebar">
                            ...
                            <p class="ap-po-details__text"><?php echo e(trans('report.products_in_report')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ap-po-details ap-po-details--3 p-25 radius-xl" style="border-left: 4px solid <?php echo e(config('branding.colors.secondary')); ?>;">
                    <div class="overview-content">
                        <div class="ap-po-details__titlebar">
                            ...
                            <p class="ap-po-details__text"><?php echo e(trans('report.total_products')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ap-po-details ap-po-details--4 p-25 radius-xl" style="border-left: 4px solid #28a745;">
                    <div class="overview-content">
                        <div class="ap-po-details__titlebar">
                            ...
                            <p class="ap-po-details__text"><?php echo e(trans('report.active_products')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ap-po-details ap-po-details--2 p-25 radius-xl" style="border-left: 4px solid #ffc107;">
                    <div class="overview-content">
                        <div class="ap-po-details__titlebar">
                            ...
                            <p class="ap-po-details__text"><?php echo e(trans('report.inactive_products')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-25">
                ...
                <div class="card radius-xl p-25 h-100">
                    <div class="card__header pb-20" style="border-bottom: 2px solid #f0f0f0;">
                        <h5 style="color: <?php echo e(config('branding.colors.primary')); ?>;">
                            <?php echo e(trans('report.products_trend')); ?></h5>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card radius-xl p-25 h-100">
                    <div class="card__header pb-20" style="border-bottom: 2px solid #f0f0f0;">
                        <h5 style="color: <?php echo e(config('branding.colors.primary')); ?>;"><?php echo e(trans('report.product_status_distribution')); ?></h5>
                    </div>
                    <div class="card__body pt-20" style="min-height: 350px; display: flex; align-items: center;">
            ...
            <div class="col-lg-12">
                <div class="userDatatable global-shadow border-light-0 p-30 bg-white radius-xl w-100 mb-30">
                    <div class="d-flex justify-content-between align-items-center mb-25">
                        <h4 class="mb-0 fw-500 fw-bold"><?php echo e(trans('menu.reports.product report')); ?></h4>
                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                <option value="approved"><?php echo e(trans('report.approved')); ?></option>
                                                <option value="pending"><?php echo e(trans('report.pending')); ?></option>
                                                <option value="rejected"><?php echo e(trans('report.rejected')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <table id="products-table" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th><span class="userDatatable-title"><?php echo e(__('report.product_name')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.sku')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.category')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.vendor')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.product_status')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.product_date')); ?></span></th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let table = $('#products-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.reports.data.products')); ?>',
                    type: 'GET',
                    data: function(d) {
                        d.per_page = d.length;
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\Modules/Report\resources/views/products.blade.php ENDPATH**/ ?>