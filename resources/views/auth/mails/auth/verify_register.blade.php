                                ...
                                <td class="bg_white email-section" style="padding-top:0;">
                                    <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                        ...
                                        @if(isset($data['verification_link']))
                                            <div style="margin: 40px 0;">
                                                <a href="{{ $data['verification_link'] }}" class="btn btn-primary" style="padding: 15px 30px; font-size: 16px; font-weight: 600; text-decoration: none; border-radius: 8px; display: inline-block;">
                                                    Verify My Email
                                                </a>
                                            </div>
