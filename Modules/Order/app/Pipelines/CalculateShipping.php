...
class CalculateShipping
{
    ...
    public function handle($payload, Closure $next)
    {
        ...
        // Only calculate shipping for existing customers with address
        if (isset($data['selected_customer_id']) && isset($data['customer_address_id'])) {
            ...
            // Calculate shipping if we have cart items
            if (!empty($cartItems)) {
                try {
