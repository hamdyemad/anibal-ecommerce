                ...
                render: function(data, type, row) {
                    return `
                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap justify-content-start">
                            ...
                            <li>
                                <a href="{{ url('admin/area-settings/subregions') }}/${row.id}" class="view" title="{{ trans('common.view') }}">
                            ...
                            <li>
                                <a href="{{ url('admin/area-settings/subregions') }}/${row.id}/edit" class="edit" title="{{ trans('common.edit') }}">
