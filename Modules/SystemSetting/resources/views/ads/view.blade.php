                            ...
                            <div class="card card-holder">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="view-item">
                                                <label class="il-gray fs-14 fw-500 mb-10">{{ __('systemsetting::ads.position') }}</label>
                                                <p class="fs-15">
                                        ...
                                        <div class="col-md-6">
                                            <div class="view-item">
                                                <label class="il-gray fs-14 fw-500 mb-10">{{ __('systemsetting::ads.status') }}</label>
                                                <p class="fs-15 color-dark fw-500">
                                                    @if($ad->active)
                                                        <span class="badge badge-round badge-success badge-lg">
                                                            <i class="uil uil-check-circle me-1"></i>{{ __('systemsetting::ads.active') }}
                                                        </span>
                                                    @else
                                                        <span class="badge badge-round badge-danger badge-lg">
                                                            <i class="uil uil-times-circle me-1"></i>{{ __('systemsetting::ads.inactive') }}
                                                        </span>
                                                    @endif
                                                </p>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="view-item">
                                                <label class="il-gray fs-14 fw-500 mb-10">{{ __('systemsetting::ads.link') }}</label>
                                                <p class="fs-15 color-dark fw-500">
                                                    @if($ad->link)
                                                        <a href="{{ $ad->link }}" target="_blank" class="text-primary">
                                                            <i class="uil uil-external-link-alt me-1"></i>{{ $ad->link }}
                                                        </a>
                                                    @else
                                        ...
                                        <div class="col-md-6">
                                            <div class="view-item">
                                                <label class="il-gray fs-14 fw-500 mb-10">{{ __('systemsetting::ads.created_at') }}</label>
                                                <p class="fs-15 color-dark fw-500">
                                        ...
                                        <div class="col-md-6">
                                            <div class="view-item">
                                                <label class="il-gray fs-14 fw-500 mb-10">{{ __('systemsetting::ads.updated_at') }}</label>
                                                <p class="fs-15 color-dark fw-500">
                        ...
                        <div class="col-md-4 order-1 order-md-2">
                            ...
                            <div class="card card-holder mb-3">
                                ...
                                <div class="card-body text-center">
                                    @if($ad->image)
                                        <img src="{{ asset('storage/' . $ad->image) }}" alt="Ad Image" class="img-fluid round" style="max-width: 100%; max-height: 300px; object-fit: cover;">
                                    @else
                                        <div class="p-5 bg-light round">
                                            <i class="uil uil-image-slash" style="font-size: 48px; color: #ccc;"></i>
                                            <p class="text-muted mt-2">{{ __('systemsetting::ads.no_image') }}</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="view-item box-items-translations">
                                            <label class="il-gray fs-14 fw-500 mb-10">{{ __('systemsetting::ads.title') }}</label>
                                            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="view-item box-items-translations">
                                            <label class="il-gray fs-14 fw-500 mb-10">{{ __('systemsetting::ads.subtitle') }}</label>
                                            <div class="row">
                                                @foreach($languages as $lang)
                                                    @php
