...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        // \App\Http\Middleware\OptionalPerformanceProfiler::class, // Only enable when debugging
    ...
    protected $middlewareGroups = [
        ...
        'api' => [
            ...
            \App\Http\Middleware\Api\ApiActivityLogMiddleware::class, // Now async - won't block response
        ],

        'api.light' => [
            // Minimal middleware for health/test endpoints
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
        ],
    ];
