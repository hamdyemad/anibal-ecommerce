@extends('layout.app')
@section('title')
    {{ trans('order::order_stage.order_stages_management') }} | Bnaia
@endsection
@push('styles')
            ...
            <div class="col-lg-12">
                ...
                <div class="userDatatable global-shadow border-light-0 p-30 bg-white radius-xl w-100 mb-30">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="created_from_filter" class="il-gray fs-14 fw-500 mb-10">
                                                ...
                                                {{ trans('order::order_stage.created_from') }}
                                            </label>
                                            <input type="date"
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="created_until_filter" class="il-gray fs-14 fw-500 mb-10">
                                                <i class="uil uil-calendar-alt me-1"></i>
                                                {{ trans('order::order_stage.created_until') }}
                                            </label>
                                            <input type="date"
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15"
                    ...
                    <div class="table-responsive">
                        <table id="orderStagesDataTable" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            let table = $('#orderStagesDataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
            ...
            $(document).on('change', '.status-switcher', function() {
                ...
                if (typeof LoadingOverlay !== 'undefined') {
                    LoadingOverlay.show({
                        text: '{{ trans('order::order_stage.status_changed_successfully') }}',
