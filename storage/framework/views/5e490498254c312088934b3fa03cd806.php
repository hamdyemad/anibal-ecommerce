...
<?php endif; ?>
        ...
        <div class="row mb-25">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="ap-po-details ap-po-details--2 p-25 radius-xl"
                    style="border-left: 4px solid <?php echo e(config('branding.colors.primary')); ?>;">
                    <div class="overview-content">
                        <div class="ap-po-details__titlebar">
                            ...
                            <p class="ap-po-details__text"><?php echo e(trans('report.customers_in_report')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="ap-po-details ap-po-details--3 p-25 radius-xl"
                    style="border-left: 4px solid <?php echo e(config('branding.colors.secondary')); ?>;">
                    <div class="overview-content">
                        <div class="ap-po-details__titlebar">
                            <h1 class="ap-po-details__title" style="color: <?php echo e(config('branding.colors.secondary')); ?>;">
                                <span id="total-count">0</span>
                            </h1>
                            <p class="ap-po-details__text"><?php echo e(trans('report.total_customers')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ap-po-details ap-po-details--4 p-25 radius-xl" style="border-left: 4px solid #28a745;">
                    <div class="overview-content">
                        <div class="ap-po-details__titlebar">
                            ...
                            <p class="ap-po-details__text"><?php echo e(trans('report.active_customers')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ap-po-details ap-po-details--2 p-25 radius-xl" style="border-left: 4px solid #ffc107;">
                    <div class="overview-content">
                        <div class="ap-po-details__titlebar">
                            ...
                            <p class="ap-po-details__text"><?php echo e(trans('report.inactive_customers')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-25">
                ...
                <div class="card radius-xl p-25 h-100">
                    <div class="card__header pb-20" style="border-bottom: 2px solid #f0f0f0;">
                        <h5 style="color: <?php echo e(config('branding.colors.primary')); ?>;">
                            <?php echo e(trans('report.customers_registration_trend')); ?></h5>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card radius-xl p-25 h-100">
                    <div class="card__header pb-20" style="border-bottom: 2px solid #f0f0f0;">
                        <h5 style="color: <?php echo e(config('branding.colors.primary')); ?>;"><?php echo e(trans('report.gender_distribution')); ?></h5>
                    </div>
                    <div class="card__body pt-20" style="min-height: 350px; display: flex; align-items: center;">
            ...
            <div class="col-lg-12">
                <div class="userDatatable global-shadow border-light-0 p-30 bg-white radius-xl w-100 mb-30">
                    <div class="d-flex justify-content-between align-items-center mb-25">
                        <h4 class="mb-0 fw-500 fw-bold"><?php echo e(trans('report.registered_customers')); ?></h4>
                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="status-filter" class="il-gray fs-14 fw-500 mb-10">
                                                ...
                                                <?php echo e(trans('report.status')); ?>

                                            </label>
                                            <select
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15 form-select"
                                                id="status-filter">
                                                <option value=""><?php echo e(trans('report.all_status')); ?></option>
                                                <option value="active"><?php echo e(trans('report.active')); ?></option>
                                                <option value="inactive"><?php echo e(trans('report.inactive')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="gender-filter" class="il-gray fs-14 fw-500 mb-10">
                                                ...
                                                <?php echo e(trans('report.gender')); ?>

                                            </label>
                                            <select
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15 form-select"
                                                id="gender-filter">
                                                <option value=""><?php echo e(trans('report.all_gender')); ?></option>
                                                <option value="male"><?php echo e(trans('report.male')); ?></option>
                                                <option value="female"><?php echo e(trans('report.female')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <table id="customers-table" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th><span class="userDatatable-title"><?php echo e(__('report.name')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.email')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.phone')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.gender')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.status')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('report.registered_date')); ?></span></th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            console.log('Initializing DataTable with URL:', '<?php echo e(route('admin.reports.data.registered-users')); ?>');
            let table = $('#customers-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.reports.data.registered-users')); ?>',
                    type: 'GET',
                    data: function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            if (data === 'male') {
                                ...
                                genderLabel = '<?php echo e(__('Male')); ?>';
                            } else if (data === 'female') {
                                genderClass = 'bg-secondary';
                                genderLabel = '<?php echo e(__('Female')); ?>';
                            } else {
                                genderClass = 'bg-danger';
                                genderLabel = '<?php echo e(__('Other')); ?>';
                            }
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return data ?
                                '<span class="badge badge-lg badge-round bg-success"><?php echo e(trans('report.active')); ?></span>' :
                                '<span class="badge badge-lg badge-round bg-danger"><?php echo e(trans('report.inactive')); ?></span>';
                        }
                    },
                    {
                        data: 'created_at',
        ...
        function initializeCharts() {
            ...
            registrationChart = new Chart(regCtx, {
                ...
                data: {
                    labels: [],
                    datasets: [{
                        label: '<?php echo e(trans('report.new_registrations')); ?>',
                        data: [],
            ...
            genderChart = new Chart(genderCtx, {
                type: 'doughnut',
                data: {
                    labels: ['<?php echo e(trans('report.male')); ?>', '<?php echo e(trans('report.female')); ?>'],
                    datasets: [{
                        data: [0, 0, 0],
                        backgroundColor: [
                            primaryColor,
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    ...
                                    label += context.parsed + ' <?php echo e(__('Customers')); ?>';
                                    return label;
                                }
                            }
                        }
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\Modules/Report\resources/views/registered-users.blade.php ENDPATH**/ ?>