            ...
            <div class="col-lg-12">
                ...
                <div class="userDatatable global-shadow border-light-0 p-30 bg-white radius-xl w-100 mb-30">
                    ...
                    <div class="alert alert-info glowing-alert" role="alert">
                        {{ __('As soon as you type anything, the search will be performed instantly (live search).') }}
                    </div>
                                ...
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <button type="button" id="exportExcel"
                                            ...
                                            <i class="uil uil-file-download-alt m-0"></i> {{ __('Export Excel Sheet') }}
                                        </button>
                                    </div>
                                    <div class="col-md-6">
                                        <button type="button" id="resetFilters"
                                            ...
                                            <i class="uil uil-redo m-0"></i> {{ __('Reset Search Form') }}
                                        </button>
                                    </div>
