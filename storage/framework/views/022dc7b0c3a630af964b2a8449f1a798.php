...
<?php endif; ?>
        ...
        <div class="row mb-25">
                ...
                <div class="card radius-xl p-25 h-100">
                    <div class="card__header pb-20" style="border-bottom: 2px solid #f0f0f0;">
                        <h5 style="color: <?php echo e(config('branding.colors.primary')); ?>;">
                            <?php echo e(__('report.customers_by_city')); ?></h5>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="card radius-xl p-25 h-100">
                    <div class="card__header pb-20" style="border-bottom: 2px solid #f0f0f0;">
                        <h5 style="color: <?php echo e(config('branding.colors.primary')); ?>;"><?php echo e(__('report.city_distribution')); ?></h5>
                    </div>
                    <div class="card__body pt-20" style="min-height: 350px; display: flex; align-items: center;">
            ...
            <div class="col-lg-12">
                <div class="userDatatable global-shadow border-light-0 p-30 bg-white radius-xl w-100 mb-30">
                    <div class="d-flex justify-content-between align-items-center mb-25">
                        <h4 class="mb-0 fw-500 fw-bold"><?php echo e(trans('menu.reports.area users')); ?></h4>
                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="search"
                                                placeholder="<?php echo e(trans('report.search')); ?>..."
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="city-filter" class="il-gray fs-14 fw-500 mb-10">
                                                <i class="uil uil-map-pin me-1"></i> <?php echo e(trans('report.city')); ?>

                                            </label>
                                            <select
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15 form-select"
                                                id="city-filter">
                                                <option value=""><?php echo e(trans('report.all_cities')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <table id="customers-table" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th><span class="userDatatable-title"><?php echo e(__('report.city')); ?></span></th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let table = $('#customers-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.reports.data.area-users')); ?>',
                    type: 'GET',
                    data: function(d) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return data ?
                                '<span class="badge badge-round badge-lg bg-success"><?php echo e(trans('report.active')); ?></span>' :
                                '<span class="badge badge-round badge-lg bg-danger"><?php echo e(trans('report.inactive')); ?></span>';
                        }
                    },
                    {
                        data: 'created_at',
        ...
        function loadCities() {
            $.ajax({
                url: '<?php echo e(route('admin.reports.get-cities')); ?>',
                type: 'GET',
                dataType: 'json',
        ...
        function initializeCharts() {
            ...
            cityChart = new Chart(cityCtx, {
                ...
                data: {
                    labels: [],
                    datasets: [{
                        label: '<?php echo e(trans('report.customers')); ?>',
                        data: [],
                        backgroundColor: [
                            primaryColor,
                            secondaryColor,
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    return context.parsed.y + ' <?php echo e(__('Customers')); ?>';
                                }
                            }
                        }
                    },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\Modules/Report\resources/views/area-users.blade.php ENDPATH**/ ?>