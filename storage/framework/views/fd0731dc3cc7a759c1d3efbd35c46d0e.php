...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('withdraw::withdraw.all_vendors_transactions')); ?> | Bnaiadsection
            ...
            <div class="col-lg-12">
                ...
                <div class="userDatatable global-shadow border-light-0 p-30 bg-white radius-xl w-100 mb-30">
                    <div class="d-flex justify-content-between align-items-center mb-25">
                        <h4 class="mb-0 fw-500"><?php echo e(__('withdraw::withdraw.all_vendors_transactions')); ?></h4>
                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="search"
                                                placeholder="<?php echo e(__('withdraw::withdraw.search')); ?>"
                                                autocomplete="off">
                                        </div>
                                    </div>
                        ...
                        <table id="citiesDataTable" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th>
                                        <span class="userDatatable-title">
                                            <?php echo e(__('withdraw::withdraw.before_sending_money')); ?>
                                    ...
                                    <th>
                                        <span class="userDatatable-title">
                                            <?php echo e(__('withdraw::withdraw.sent_amount')); ?>
                                    ...
                                    <th>
                                        <span class="userDatatable-title">
                                            <?php echo e(__('withdraw::withdraw.after_sending_amount')); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#citiesDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.allVendorsTransactionsDatatable')); ?>',
                    type: 'GET',
                    data: function(d) {
                        d.per_page = d.length;
                    ...
                    { // Vendor (Logo + Name)
                        ...
                        render: function(data, type, row) {
                            ...
                            const logo = data.logo ?
                                ...
                                `<div class='me-1' style="width:40px; height:40px; border-radius:50%; background:#f0f0f0; display:flex; align-items:center; justify-content:center; font-size:12px; color:#666;"><?php echo e(__('withdraw::withdraw.no_logo')); ?></div>`;
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\Modules/Withdraw\resources/views/all_vendors_transactions.blade.php ENDPATH**/ ?>