                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <x-vendor::order-statistics :orderStats="$orderStats" />

                                {{-- Vendor Products Table Component --}}
                                <x-vendor::vendor-products-table :vendor="$vendor" />

                                {{-- Order Products Table Component --}}
                                <x-vendor::order-products-table :vendor="$vendor" />

                                {{-- Vendor Withdraws Table Component --}}
                                <x-vendor::vendor-withdraws-table :vendor="$vendor" />
                            </div>
                        </div>
                    </div>
                </div>
