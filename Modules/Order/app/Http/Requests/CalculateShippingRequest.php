...
class CalculateShippingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cart_items.*.department_id' => 'nullable|integer|exists:departments,id',
            'cart_items.*.department_name' => 'nullable|string',
            'cart_items.*.sub_category_id' => 'nullable|integer|exists:sub_categories,id',
            'cart_items.*.sub_category_name' => 'nullable|string',
    ...
    public function messages(): array
    {
        return [
            ...
            'cart_items.*.department_id.exists' => trans('shipping.department_id_not_found'),
            'cart_items.*.sub_category_id.exists' => trans('shipping.sub_category_id_not_found'),
