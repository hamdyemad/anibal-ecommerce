...
@section('content')
                            ...
                            <div class="col-md-8 order-2 order-md-1">
                                <div class="card card-holder">
                                    <div class="card-header">
                                        <h3>
                                            <i
                                                class="uil uil-info-circle me-1"></i>{{ trans('order::order_stage.basic_information') }}
                                        </h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <x-translation-display :label="trans('order::order_stage.name')" :model="$orderStage" fieldName="name"
                                                :languages="$languages" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    <label
                                                        class="il-gray fs-14 fw-500 mb-10">{{ trans('order::order_stage.status') }}</label>
                                                    <p class="fs-15 color-dark fw-500">
                                                        @if ($orderStage->active)
                                                            <span
                                                                class="badge badge-success badge-lg badge-round">{{ trans('order::order_stage.active') }}</span>
                                                        @else
                                                            <span
                                                                class="badge badge-secondary badge-lg badge-round">{{ trans('order::order_stage.inactive') }}</span>
                                                        @endif
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    <label
                                                        class="il-gray fs-14 fw-500 mb-10">{{ trans('order::order_stage.sort_order') }}</label>
                                                    <p class="fs-15 color-dark fw-500">
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    <label
                                                        class="il-gray fs-14 fw-500 mb-10">{{ trans('order::order_stage.system_stage') }}</label>
                                                    <p class="fs-15 color-dark fw-500">
                                                        @if ($orderStage->is_system)
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    <label
                                                        class="il-gray fs-14 fw-500 mb-10">{{ __('main.created_at') }}</label>
                                                    <p class="fs-15 color-dark fw-500">
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    <label
                                                        class="il-gray fs-14 fw-500 mb-10">{{ __('main.updated_at') }}</label>
                                                    <p class="fs-15 color-dark fw-500">
                                ...
                                <div class="card card-holder">
                                    ...
                                    <div class="card-body text-center">
                                        <div class="color-display-wrapper"
                                            onclick="copyColorToClipboard('{{ $orderStage->color }}')"
                                            title="{{ __('main.click_to_copy') }}">
                                            <div class="d-flex flex-column align-items-center justify-content-center"
                                                style="height: 200px;">
                                                <div class="mb-3"
                                                    style="width: 80px; height: 80px; background-color: {{ $orderStage->color }}; border-radius: 50%; border: 3px solid #fff; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
                                                </div>
                                                <h5 class="mb-2 fw-600" id="colorCode">{{ $orderStage->color }}</h5>
                                                <small class="text-muted">{{ trans('order::order_stage.color') }} - <span
                                                        class="text-primary">{{ __('main.click_to_copy') }}</span></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <x-delete-with-loading modalId="deleteOrderStageModal" tableId="" deleteButtonClass="delete-order-stage-btn"
        :title="trans('order::order_stage.delete_order_stage')" :message="trans('order::order_stage.delete_confirmation')" itemNameId="orderStageName" confirmBtnId="confirmDeleteOrderStage"
        :loadingText="trans('main.deleting')" :successMessage="trans('order::order_stage.order_stage_deleted')" :errorMessage="trans('order::order_stage.error_deleting_order_stage')" />
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.delete-order-stage-btn', function() {
                    ...
                    const deleteUrl = '{{ route('admin.order-stages.destroy', ':id') }}'.replace(':id',
                        orderStageId);
