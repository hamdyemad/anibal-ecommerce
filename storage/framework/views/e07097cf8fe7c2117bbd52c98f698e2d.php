...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('withdraw::withdraw.all_withdraw_transactions')); ?> | Bnaia
...
<?php endif; ?>
            ...
            <div class="col-lg-12">
                ...
                <div class="userDatatable global-shadow border-light-0 p-30 bg-white radius-xl w-100 mb-30">
                    <div class="d-flex justify-content-between align-items-center mb-25">
                        <h4 class="mb-0 fw-500"><?php echo e(__('withdraw::withdraw.all_withdraw_transactions')); ?></h4>
                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="status_filter" class="il-gray fs-14 fw-500 mb-10">
                                                ...
                                                <?php echo e(__('withdraw::withdraw.status')); ?>

                                            </label>
                                            <select
                                                class="select2 form-control ih-medium ip-gray radius-xs b-light px-15 form-select"
                                                id="status_filter">
                                                <option value=""><?php echo e(__('withdraw::withdraw.all')); ?> <?php echo e(__('withdraw::withdraw.status')); ?></option>
                                                <option value="new"><?php echo e(__('withdraw::withdraw.new')); ?></option>
                                                <option value="accepted"><?php echo e(__('withdraw::withdraw.accepted')); ?></option>
                                                <option value="rejected"><?php echo e(__('withdraw::withdraw.rejected')); ?></option>
                                            </select>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="approveModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?php echo e(route('admin.changeTransactionRequestsStatus')); ?>"
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#citiesDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.allTransactionsDatabase')); ?>',
                    type: 'GET',
                    data: function(d) {
                        d.per_page = d.length;
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\Modules/Withdraw\resources/views/all_transactions.blade.php ENDPATH**/ ?>