<div class="col-12 col-md-6 mb-25">
    <div class="card border-0 px-25">
        <div class="card-header px-0 border-0">
            <h6 style="font-weight: bold"><?php echo e(trans('dashboard.total_sales')); ?></h6>
            <div class="card-extra">
                <ul class="card-tab-links nav-tabs nav" role="tablist">
                    <li>
                        <a href="#totalsales-today" data-bs-toggle="tab" id="totalsales-today-tab"
                            role="tab" aria-selected="false" style="font-size: 12px"><?php echo e(trans('dashboard.today')); ?></a>
                    </li>
                    <li>
                        <a href="#totalsales-week" data-bs-toggle="tab" id="totalsales-week-tab"
                            role="tab" aria-selected="false" style="font-size: 12px"><?php echo e(trans('dashboard.week')); ?></a>
                    </li>
                    <li>
                        <a href="#totalsales-month" data-bs-toggle="tab" id="totalsales-month-tab"
                            role="tab" aria-selected="false" style="font-size: 12px"><?php echo e(trans('dashboard.month')); ?></a>
                    </li>
                    <li>
...
<?php /**PATH C:\laragon\www\eramo-multi-vendor\resources\views/pages/dashboard/total-sales-chart.blade.php ENDPATH**/ ?>