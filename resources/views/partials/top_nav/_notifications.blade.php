                    ...
                    @foreach($notifications as $notification)
                        <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                            ...
                            <div class="nav-notification__details">
                                <p>
                                    <a href="{{ route('admin.notifications.show', ['lang' => app()->getLocale(), 'countryCode' => strtolower(session('country_code', 'eg')), 'id' => $notification['id']]) }}" class="subject stretched-link text-truncate" style="max-width: 180px;">{{ $notification['title'] }}</a>
