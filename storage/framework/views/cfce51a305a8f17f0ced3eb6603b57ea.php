...
<?php $__env->startSection('title', (isset($category)) ? trans('categorymanagment::category.edit_category') : trans('categorymanagment::category.create_category')); ?>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom py-20">
                        <h5 class="mb-0 fw-500">
                            <?php echo e(isset($category) ? trans('categorymanagment::category.edit_category') : trans('categorymanagment::category.create_category')); ?>
                    ...
                    <div class="card-body">
                        ...
                        <form id="categoryForm"
                              action="<?php echo e(isset($category) ? route('admin.category-management.categories.update', $category->id) : route('admin.category-management.categories.store')); ?>"
                              method="POST"
                                    ...
                                    <div class="col-md-6 mb-25">
                                        <div class="form-group">
                                            <label for="translation_<?php echo e($language->id); ?>_name" class="il-gray fs-14 fw-500 mb-10" <?php if($language->rtl): ?> dir="rtl" style="text-align: right; display: block;" <?php endif; ?>>
                                                ...
                                                <?php else: ?>
                                                    <?php echo e(trans('categorymanagment::category.name_english')); ?> (<?php echo e($language->name); ?>) <span class="text-danger">*</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </label>
                                            <input type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(isset($category) ? ($category->getTranslation('name', $language->code) ?? '') : old('translations.' . $language->id . '.name')); ?>"
                                                   placeholder="<?php if($language->code == 'ar'): ?>أدخل اسم الفئة بالعربية<?php else: ?><?php echo e(trans('categorymanagment::category.enter_category_name_english')); ?><?php endif; ?>"
                                    ...
                                    <div class="col-md-6 mb-25">
                                        <div class="form-group">
                                            <label for="translation_<?php echo e($language->id); ?>_description" class="il-gray fs-14 fw-500 mb-10" <?php if($language->rtl): ?> dir="rtl" style="text-align: right; display: block;" <?php endif; ?>>
                                                ...
                                                <?php else: ?>
                                                    <?php echo e(trans('categorymanagment::category.description')); ?> (<?php echo e($language->name); ?>)
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </label>
                                            <textarea
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   rows="4"
                                                   placeholder="<?php if($language->code == 'ar'): ?>أدخل وصف الفئة بالعربية<?php else: ?><?php echo e(trans('categorymanagment::category.enter_category_description_english')); ?><?php endif; ?>"
                                                   <?php if($language->rtl): ?> dir="rtl" <?php endif; ?>
                                                   data-lang="<?php echo e($language->code); ?>"><?php echo e(isset($category) ? ($category->getTranslation('description', $language->code) ?? '') : old('translations.' . $language->id . '.description')); ?></textarea>
                                ...
                                <div class="col-md-6 mb-25">
                                    <div class="form-group">
                                        <label for="departments" class="il-gray fs-14 fw-500 mb-10">
                                            <?php echo e(trans('categorymanagment::category.departments')); ?> <span class="text-danger">*</span>
                                        </label>
                                        <select id="departments" class="form-control select2 <?php $__errorArgs = ['department_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="department_id">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if(isset($category) && $category->department_id == $department['id']): ?> selected <?php endif; ?>
                                ...
                                <div class="col-md-6 mb-25">
                                    <div class="form-group">
                                        <label for="sort_number" class="il-gray fs-14 fw-500 mb-10">
                                            <?php echo e(trans('categorymanagment::category.sort_number') ?? 'Sort Number'); ?>
...
unset($__errorArgs, $__bag); ?>"
                                               id="sort_number"
                                               name="sort_number"
                                               value="<?php echo e(old('sort_number', $category->sort_number ?? 0)); ?>"
                                               min="0">
                                ...
                                <div class="col-md-6 mb-25">
                                    <div class="form-group">
                                        <label class="il-gray fs-14 fw-500 mb-10 d-block">
                                            <?php echo e(trans('categorymanagment::category.activation')); ?>
                                        ...
                                        <div class="dm-switch-wrap d-flex align-items-center">
                                            <div class="form-check form-switch form-switch-primary form-switch-md">
                                                ...
                                                <input type="checkbox"
                                                       ...
                                                       name="active"
                                                       value="1"
                                                       <?php echo e(old('active', $category->active ?? 1) == 1 ? 'checked' : ''); ?>>
                                            </div>
                                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="col-md-6 mb-25">
                                    <div class="form-group">
                                        <label class="il-gray fs-14 fw-500 mb-10 d-block">
                                            <?php echo e(trans('categorymanagment::category.view_status') ?? 'View Status'); ?>
                                        ...
                                        <div class="dm-switch-wrap d-flex align-items-center">
                                            <div class="form-check form-switch form-switch-primary form-switch-md">
                                                ...
                                                <input type="checkbox"
                                                       ...
                                                       name="view_status"
                                                       value="1"
                                                       <?php echo e(old('view_status', $category->view_status ?? 1) == 1 ? 'checked' : ''); ?>>
                                            </div>
                                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image-upload','data' => ['id' => 'category_image','name' => 'image','label' => trans('categorymanagment::category.image'),'placeholder' => trans('categorymanagment::category.click_to_upload_image'),'recommendedSize' => trans('categorymanagment::category.recommended_size'),'existingImage' => isset($category) && $category->image ? $category->image : null,'aspectRatio' => 'square']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'category_image','name' => 'image','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('categorymanagment::category.image')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('categorymanagment::category.click_to_upload_image')),'recommendedSize' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('categorymanagment::category.recommended_size')),'existingImage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($category) && $category->image ? $category->image : null),'aspectRatio' => 'square']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <div class="col-md-6 mb-25">
                                    <?php if (isset($component)) { $__componentOriginaldbebdfa49a0907927fe266159631a348 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldbebdfa49a0907927fe266159631a348 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image-upload','data' => ['id' => 'category_icon','name' => 'icon','label' => trans('categorymanagment::category.icon'),'placeholder' => trans('categorymanagment::category.click_to_upload_icon'),'recommendedSize' => trans('categorymanagment::category.recommended_size_for_icon'),'existingImage' => isset($category) && $category->icon ? $category->icon : null,'aspectRatio' => 'square']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('image-upload'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'category_icon','name' => 'icon','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('categorymanagment::category.icon')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('categorymanagment::category.click_to_upload_icon')),'recommendedSize' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('categorymanagment::category.recommended_size_for_icon')),'existingImage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($category) && $category->icon ? $category->icon : null),'aspectRatio' => 'square']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldbebdfa49a0907927fe266159631a348)): ?>
<?php $attributes = $__attributesOriginaldbebdfa49a0907927fe266159631a348; ?>
                            ...
                            <div class="d-flex justify-content-end gap-15 mt-30">
                                <a href="<?php echo e(route('admin.category-management.categories.index')); ?>"
                                   class="btn btn-light btn-default btn-squared fw-400 text-capitalize">
                                    <i class="uil uil-angle-left"></i> <?php echo e(trans('categorymanagment::category.cancel')); ?>
                                ...
                                <button type="submit" id="submitBtn"
                                    ...
                                    <span><?php echo e(isset($category) ? trans('categorymanagment::category.update_category') : trans('categorymanagment::category.add_category')); ?></span>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if ($.fn.select2) {
                ...
                $('#departments').select2({
                    theme: 'bootstrap-5',
                    width: '100%',
                    placeholder: '<?php echo e(trans('categorymanagment::category.select_departments')); ?>',
                    allowClear: true
                });
                ...
                $('.select2-ajax').select2({
                    theme: 'bootstrap-5',
                    width: '100%',
                    placeholder: '<?php echo e(trans('categorymanagment::category.select_activities')); ?>',
                    allowClear: true,
                    ajax: {
                        url: function() {
            ...
            categoryForm.addEventListener('submit', function(e) {
                ...
                const loadingText = <?php echo json_encode(isset($category) ? trans('loading.updating') : trans('loading.creating'), 15, 512) ?>;
                ...
                .then(data => {
                    ...
                    return LoadingOverlay.animateProgressBar(100, 200).then(() => {
                        ...
                        const successMessage = <?php echo json_encode(isset($category) ? trans('loading.updated_successfully') : trans('loading.created_successfully'), 15, 512) ?>;
                        ...
                        setTimeout(() => {
                            window.location.href = data.redirect || '<?php echo e(route("admin.category-management.categories.index")); ?>';
                        }, 1500);
                    });
                })
                .catch(error => {
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\Modules/CategoryManagment\resources/views/category/form.blade.php ENDPATH**/ ?>