...
class CustomerServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(
            \Modules\Customer\app\Interfaces\CustomerRepositoryInterface::class,
            \Modules\Customer\app\Repositories\CustomerRepository::class
        );

        $this->app->bind(
            \Modules\Customer\app\Interfaces\Api\CustomerApiRepositoryInterface::class,
        ...
        $this->app->singleton(
            \Modules\Customer\app\Actions\CreateCustomerAction::class,
            \Modules\Customer\app\Actions\CreateCustomerAction::class
        );

        // Register Service bindings
        $this->app->bind(
            \Modules\Customer\app\Services\Api\CustomerAuthService::class,
            function ($app) {
                return new \Modules\Customer\app\Services\Api\CustomerAuthService(
                    $app->make(\Modules\Customer\app\Interfaces\Api\CustomerApiRepositoryInterface::class),
                    $app->make(\Modules\Customer\app\Actions\ValidateOtpAction::class),
                );
            }
        );
